...
public class Vector3PathFromChildTransforms : MonoBehaviour {
	...
	public Transform localToTransform;
	...
	public bool CreatePathAssetFromChildren(){
		if(nameOfPath == ""){
		...
		string filePath = "Assets/Scripts/Helpers/Vector3Paths/" + nameOfPath + (localCoordinates ? "Local" : "World") + ".asset";
